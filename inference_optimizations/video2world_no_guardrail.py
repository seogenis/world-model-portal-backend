...
# Import the no-guardrail versions
...
def main(args):
    ...
    # Print after distributed environment is initialized
    print_rank_0("Running with guardrails disabled for speed optimization")

    # Only download tokenizer if needed
